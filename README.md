...
-----------
rails new my_app -m https://raw.githubusercontent.com/atomicjolt/quizzle/master/template.rb
...
-----------
1. Open application.rb and change `Quizzle` to the name you choose.
2. Do a global search and replace for `quizzle` and change it to the name you choose.
3. Do a global search and replace for `Quizzle` (use only letters or numbers for this name. Special characters like '_' will result in errors).
...
-----------
**Oauth2 Redirect URI:**
https://Quizzle.atomicjolt.xyz/auth/[provider]/callback

**Icon URL:**
https://Quizzle.atomicjolt.xyz/oauth_icon.png
